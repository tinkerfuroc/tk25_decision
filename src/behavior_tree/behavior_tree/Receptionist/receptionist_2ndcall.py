...
# Use configuration system instead of hardcoded flag
# Set environment variable BT_MOCK_MODE=true to enable mock mode
# or BT_MOCK_MODE=false to use real hardware
