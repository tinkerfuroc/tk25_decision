...
TASK_SPECS: Dict[str, Dict[str, List]] = {
    "hri": {
        ...
        "actions": [
            ("/feature_extraction_service",  "tinker_vision_msgs_26/action/FeatureExtraction"),
            ("/feature_matching_service",    "tinker_vision_msgs_26/action/FeatureMatching"),
            ("/seat_recommend_service",      "tinker_vision_msgs_26/action/SeatRecommendation"),
            ("/seat_recommend_bbox_service", "tinker_vision_msgs_26/action/SeatRecommendBbox"),
    ...
    "restaurant": {
        ...
        "actions": [
            ("/detect_waving_persons",       "tinker_vision_msgs_26/action/DetectWaving"),
            ("/order_extraction_action",     "tinker_audio_msgs/action/OrderExtraction"),
            ("/navigate_to_pose",            "nav2_msgs/action/NavigateToPose"),
        ],
