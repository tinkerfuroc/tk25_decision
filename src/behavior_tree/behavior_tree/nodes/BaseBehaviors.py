...
from behavior_tree.core.config import (
    is_node_mocked,
...
from behavior_tree.core.mock_input import get_mock_input_controller
import sys
import tty
import termios
...
class ServiceHandler(py_trees.behaviour.Behaviour):
        ...
        **kwargs : dict
        ...
        if not self.mock_mode:
            ...
            if isinstance(service_mod, str) and service_mod.startswith(
                "behavior_tree.interfaces.mock_messages"
            ):
                print(
    ...
    def _setup_mock_teleop_node(self):
        try:
            from behavior_tree.nodes.TeleopNodes import BtNode_MoveArmTeleop
